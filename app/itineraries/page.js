    ...
    <div>
      ...
      <section className="bg-ivory">
        <div className="container-editorial py-16 md:py-24">
          <div className="text-center mb-14">
            <h2 className="font-archivo uppercase text-3xl sm:text-4xl text-ink mb-3">Destinations</h2>
            ...
            {journeys.map((journey) => (
              <article key={journey.slug} className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
                <div className="md:col-span-5">
                  <div className="relative aspect-[4/3] rounded-[25px] overflow-hidden">
                    <MediaFrame
                      src={journey.image}
                ...
                <div className="md:col-span-6 md:col-start-7">
                  ...
                  <h3 className="font-archivo uppercase text-2xl sm:text-3xl text-ink leading-tight mb-4">
                    {journey.name}
                  </h3>
                    ...
                    <ol className="flex flex-wrap gap-2">
                      {journey.stops.map((stop, i) => (
                        <li key={stop} className="flex items-center gap-2 text-xs text-ink/70">
                          <span className="text-gold tabular-nums font-archivo">{String(i + 1).padStart(2, "0")}</span>
                          {stop}
                  ...
                  <div className="flex flex-wrap gap-4">
                    <Link
                      ...
                      className="text-xs uppercase tracking-widest2 px-6 py-2.5 rounded-full border border-clay text-clay hover:bg-clay hover:text-ivory transition-all"
                    >
                      View Destination
                    </Link>
                    <Link
                      href="/contact"
                      className="text-xs uppercase tracking-widest2 px-6 py-2.5 rounded-full bg-clay text-ivory hover:bg-clay-dark transition-colors"
                    >
                      Request a Quote
                    </Link>
                  </div>
      ...
      <section className="bg-sand">
        <div className="container-editorial py-16 md:py-20 text-center">
          <p className="font-archivo uppercase text-2xl sm:text-3xl text-clay leading-snug max-w-2xl mx-auto text-balance">
          ...
          <Link
            href="/contact"
            className="mt-6 inline-block text-xs uppercase tracking-widest2 px-8 py-3 rounded-full bg-clay text-ivory hover:bg-clay-dark transition-colors"
          >
            Contact Us
          </Link>
        </div>
