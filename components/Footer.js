        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 items-start">
          ...
          <div className="md:col-span-3 md:col-start-7">
            ...
            <div className="flex gap-4">
              ...
              <a href="https://youtube.com/@mutotours" target="_blank" rel="noopener noreferrer" className="text-ivory/60 hover:text-gold transition-colors" aria-label="YouTube">
          ...
          <div className="md:col-span-2 md:col-start-11">
            ...
            <div className="flex flex-col gap-3">
              <span className="text-xs text-ivory/40">ATTA</span>
              <span className="text-xs text-ivory/40">KAZA</span>
              <span className="text-xs text-ivory/40">SATSA</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href="/destinations/victoria-falls" className="text-sm text-ivory/70 hover:text-gold transition-colors">Victoria Falls</Link></li>
              ...
              <li><Link href="/destinations/hwange-national-park" className="text-sm text-ivory/70 hover:text-gold transition-colors">Hwange</Link></li>
