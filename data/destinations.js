...
//
// Imagery now uses the higher-quality photographs from the live site
// (mutotours.africa): each destination is anchored with its matching
// package/landmark photo, and sub-galleries draw from the live gallery set
// at /images/gallery/.
// ---------------------------------------------------------------------------
...
export const destinations = [
  {
    ...
    imageAlt: "The spray and cliffs of Victoria Falls, the smoke that thunders",
    highlights: [
  ...
  },
  {
    ...
    imageAlt: "A safari game drive through Hwange National Park, Zimbabwe",
    highlights: [
  ...
  },
  {
    ...
    image: "/images/chobe.jpg",
    imageAlt: "Scenic view of Chobe National Park, Botswana on the Chobe River",
    highlights: [
  ...
  },
  {
    ...
    image: "/images/maun.jpg",
    imageAlt: "The waterways of the Okavango Delta near Maun, Botswana",
    highlights: [
    ...
    gallery: [
      ...
      "/images/gallery/g30.jpg",
      "/images/gallery/g62.jpg",
      "/images/gallery/g71.jpg",
      "/images/gallery/g100.jpg",
    ],
  ...
  },
  {
    ...
    imageAlt: "The red dunes and desert landscape of Namibia",
    highlights: [
    ...
    gallery: [
      "/images/gallery/g64.jpg",
      "/images/gallery/g91.jpg",
      "/images/gallery/g92.jpg",
      "/images/gallery/g130.jpg",
      "/images/gallery/g133.jpg",
      "/images/gallery/g151.jpg",
    ],
  ...
  },
  {
    ...
    image: "/images/joburg-vicfalls-14.jpg",
    imageAlt: "The South African landscape on the Johannesburg to Victoria Falls route",
    highlights: [
  ...
  },
  {
    ...
    imageAlt: "The granite kopjes and landscapes of Zimbabwe's Matobo Hills region",
    highlights: [
